...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CREDICOIN " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"161.35.59.25", "161.35.59.25"},
	{"134.122.118.121", "134.122.118.121"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CREDICOIN is probably already running."), addrBind.ToString().c_str());
        else
