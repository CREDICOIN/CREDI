...
QString TransactionDesc::toHTML(CWallet *wallet, CWalletTx &wtx)
{
...

    {
        ...
        if (wtx.IsCoinBase() && nCREDIit == 0)
        {
            ...
            int64 nUnmatured = 0;
            BOOST_FOREACH(const CTxOut& txout, wtx.vout)
                nUnmatured += wallet->GetCREDIit(txout);
            strHTML += "<b>" + tr("CREDIit") + ":</b> ";
        ...
        else if (nNet > 0)
        {
            ...
            // CREDIit
            //
            strHTML += "<b>" + tr("CREDIit") + ":</b> " + BitcoinUnits::formatWithUnit(BitcoinUnits::BTC, nNet) + "<br>";
        }
        else
        {
            ...
            if (fAllFromMe)
            {
                ...
                if (fAllToMe)
                {
                    ...
                    int64 nValue = nCREDIit - nChange;
                    strHTML += "<b>" + tr("Debit") + ":</b> " + BitcoinUnits::formatWithUnit(BitcoinUnits::BTC, -nValue) + "<br>";
                    strHTML += "<b>" + tr("CREDIit") + ":</b> " + BitcoinUnits::formatWithUnit(BitcoinUnits::BTC, nValue) + "<br>";
                }
            ...
            else
            {
                ...
                BOOST_FOREACH(const CTxOut& txout, wtx.vout)
                    if (wallet->IsMine(txout))
                        strHTML += "<b>" + tr("CREDIit") + ":</b> " + BitcoinUnits::formatWithUnit(BitcoinUnits::BTC, wallet->GetCREDIit(txout)) + "<br>";
            }
        }
